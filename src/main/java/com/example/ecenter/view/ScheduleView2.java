/*
 * TODO
 * make day view button go to today's date if viewing another month/week 
 * and then clicking 'day' button
 */
...
public class ScheduleView2 extends GridLayout implements View 
{
    ...
    private Button monthButton, weekButton, dayButton, nextButton, prevButton, addNewEvent;
    private ComboBox timeZoneSelect, formatSelect, localeSelect;
    private CheckBox hideWeekendsButton, readOnlyButton, disabledButton;
    ...
    private Button deleteEventButton, applyEventButton;
	...
	{
		//For some reason this returns the start of the month
		Date originalDate = calendar.getTime();
		
		// as a workaround we add the difference in days
		calendar.add(GregorianCalendar.DAY_OF_MONTH, +rollAmount);

		/*
		 * create 2 new events, both start and end at 16:00 and 17:00 respectively
		 * on the current day
		 */
    ...
    private void initLayoutContent() 
    {
        ...
        Label viewCaption = new Label("Electrolysis Center Schedule");
    ...
    private void initFormFields(Layout formLayout,
        ...
        startDateField = createDateField("Start Date of week");
        endDateField = createDateField("End Date of week");
       ...
       /* allDayField.addValueChangeListener(new Property.ValueChangeListener() {
        ...
        scheduledEventBinder.bind(allDayField, "allDay");
    }
    ...
    private void initCalendar() {
        ...
        if (firstHour != null && lastHour != null) {
            ...
            calendarComponent.setLastVisibleHourOfDay(20);
        }
        ...
        rollAmount = calendar.get(GregorianCalendar.DAY_OF_MONTH) - 1;
        calendar.add(GregorianCalendar.DAY_OF_MONTH, -rollAmount);
